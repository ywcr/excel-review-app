...
const testData = [
  ...
  // Valid data
  [1, '产品推广', '李四', '张三', '康美药店', '北京市朝阳区', '2024-01-01', '90', '产品介绍', '客户感兴趣', '', '', '是', '否'],
  [2, '市场调研', '李四', '王五', '健康药房', '北京市海淀区', '2024-01-02', '75', '市场调研', '配合度高', '', '', '是', '否'],
  [3, '产品推广', '张七', '赵六', '民生药店', '北京市西城区', '2024-01-01', '120', '产品推广', '有购买意向', '', '', '是', '否'],

  // Error cases for testing
  [4, '重复拜访', '李四', '张三', '康美药店', '北京市朝阳区', '2024-01-01', '60', '重复拜访同一药店同一天', '违反规则', '', '', '是', '否'], // 违反1日内不重复拜访
  [5, '重复对接人', '李四', '张三', '新华药店', '北京市东城区', '2024-01-08', '65', '重复拜访同一对接人7日内', '违反规则', '', '', '是', '否'], // 违反7日内对接人不重复
  [6, '超限拜访', '李四', '钱八', '仁和药店', '北京市丰台区', '2024-01-01', '80', '第6家药店', '违反规则', '', '', '是', '否'], // 违反每日不超过5家
  [7, '时长不足', '张七', '孙九', '平安药店', '北京市石景山区', '2024-01-02', '45', '时长不足', '违反规则', '', '', '是', '否'], // 违反60分钟最低要求
  [8, '超时拜访', '张七', '周十', '同仁药店', '北京市门头沟区', '2024-01-02', '70', '超出时间范围', '违反规则', '', '', '是', '否'], // 违反08:00-19:00时间范围
];
